...
class MazeEnv(gym.Env):
    ...
    def __init__(
        ...
        import sys
        sys.path.insert(
            0, '/Users/petroschristodoulou/Documents/Deep_RL_Implementations/Environments')
        sys.path.insert(
            0, '/Users/petroschristodoulou/Documents/Deep_RL_Implementations/Environments/environments')
        ...
        # ET.parse(xml_path)
        tree = ET.parse(
            "/Users/petroschristodoulou/Documents/Deep_RL_Implementations/Environments/ant_environments/" + xml_path[13:])
